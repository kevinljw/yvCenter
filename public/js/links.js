$(document).ready(function() {
  ...
  allLinksArr.forEach(function(eachLink){
    ...
    $('#carousel_'+eachLink.area+' .item:eq('+index+')').append('<div class="col-sm-6"><a href="'+eachLink.link+'" target="_blank"><img src="/uploads/'+eachLink.picture+'" alt="'+eachLink.name+'" height="160px"/><h3>'+eachLink.name+'</h3></a></div>');
  });
});
